...
// on android import org.spongycastle.jce.provider.BouncyCastleProvider;
...
public class Decrypt12 {
    ...
    public static void decrypt(String KeyFile, String C12File, String SQLFile) throws Exception {
        ...
        if (!new String(T1, 0, T1.length, StandardCharsets.US_ASCII).equals(new String(T2, 0, T2.length, StandardCharsets.US_ASCII)))
